...
const init = require("./init-f937d626.js");
...
function labConvert(o) {
  ...
  if (o instanceof Hcl)
    return hcl2lab(o);
  if (!(o instanceof mermaid_core.Rgb))
    o = mermaid_core.rgbConvert(o);
...
mermaid_core.define(Lab, lab, mermaid_core.extend(mermaid_core.Color, {
  brighter(k) {
...
mermaid_core.define(Hcl, hcl$1, mermaid_core.extend(mermaid_core.Color, {
  brighter(k) {
...
function interpolate(a, b) {
  var t = typeof b, c;
  return b == null || t === "boolean" ? mermaid_core.constant(b) : (t === "number" ? mermaid_core.interpolateNumber : t === "string" ? (c = mermaid_core.color(b)) ? (b = c, mermaid_core.interpolateRgb) : mermaid_core.interpolateString : b instanceof mermaid_core.color ? mermaid_core.interpolateRgb : b instanceof Date ? date$1 : isNumberArray(b) ? numberArray : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object : mermaid_core.interpolateNumber)(a, b);
}
...
function hcl(hue) {
  return function(start, end) {
    var h = hue((start = hcl$1(start)).h, (end = hcl$1(end)).h), c = mermaid_core.nogamma(start.c, end.c), l = mermaid_core.nogamma(start.l, end.l), opacity = mermaid_core.nogamma(start.opacity, end.opacity);
    return function(t) {
      start.h = h(t);
      start.c = c(t);
      start.l = l(t);
...
const interpolateHcl = hcl(mermaid_core.hue);
...
function transformer() {
  ...
  scale.invert = function(y) {
    return clamp(untransform((input || (input = piecewise(range, domain.map(transform), mermaid_core.interpolateNumber)))(y)));
  };
...
function calendar(ticks2, tickInterval2, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale.copy = function() {
    return copy(scale, calendar(ticks2, tickInterval2, year, month, week, day, hour, minute, second2, format2));
  };
  return scale;
}
function time() {
  return init.initRange.apply(calendar(timeTicks, timeTickInterval, timeYear, timeMonth, timeSunday, timeDay, timeHour, timeMinute, second, timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
var isoWeekExports = {};
var isoWeek = {
  get exports() {
...
(function(module2, exports2) {
  !function(e, t) {
    module2.exports = t();
  }(mermaid_core.commonjsGlobal, function() {
    var e = "day";
        ...
        if ("string" == typeof a2) {
          ...
          h2 && (d2 = s2[2]), o = this.$locale(), !f2 && d2 && (o = n2.Ls[d2]), this.$d = function(e6, t6, n3) {
            try {
              ...
              var r4 = c(t6)(e6), i3 = r4.year, o2 = r4.month, s3 = r4.day, a3 = r4.hours, f3 = r4.minutes, h3 = r4.seconds, u3 = r4.milliseconds, d3 = r4.zone, l2 = /* @__PURE__ */ new Date(), m2 = s3 || (i3 || o2 ? 1 : l2.getDate()), M2 = i3 || l2.getFullYear(), Y = 0;
...
mermaid_core.dayjs.extend(dayjsIsoWeek);
mermaid_core.dayjs.extend(dayjsCustomParseFormat);
mermaid_core.dayjs.extend(dayjsAdvancedFormat);
let dateFormat = "";
let axisFormat = "";
...
const checkTaskDates = function(task, dateFormat2, excludes2, includes2) {
  ...
  if (task.startTime instanceof Date) {
    startTime = mermaid_core.dayjs(task.startTime);
  } else {
    startTime = mermaid_core.dayjs(task.startTime, dateFormat2, true);
  }
  startTime = startTime.add(1, "d");
  let originalEndTime;
  if (task.endTime instanceof Date) {
    originalEndTime = mermaid_core.dayjs(task.endTime);
  } else {
    originalEndTime = mermaid_core.dayjs(task.endTime, dateFormat2, true);
  }
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  let mDate = mermaid_core.dayjs(str, dateFormat2.trim(), true);
  if (mDate.isValid()) {
    return mDate.toDate();
  } else {
    mermaid_core.log.debug("Invalid date:" + str);
    mermaid_core.log.debug("With date format:" + dateFormat2.trim());
...
const getEndDate = function(prevTime, dateFormat2, str, inclusive = false) {
  ...
  let endTime = mermaid_core.dayjs(prevTime);
...
const compileData = function(prevTask, dataStr) {
  ...
  if (endTimeData) {
    ...
    task.manualEndTime = mermaid_core.dayjs(endTimeData, "YYYY-MM-DD", true).isValid();
  ...
  const compileTask = function(pos) {
    ...
    if (rawTasks[pos].startTime) {
      ...
      if (rawTasks[pos].endTime) {
        ...
        rawTasks[pos].manualEndTime = mermaid_core.dayjs(
          rawTasks[pos].raw.endTime.data,
          "YYYY-MM-DD",
          true
        ).isValid();
...
const setLink = function(ids, _linkStr) {
  ...
  if (mermaid_core.getConfig().securityLevel !== "loose") {
    linkStr = mermaid_core.sanitizeUrl_1(_linkStr);
  }
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      mermaid_core.utils.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => mermaid_core.getConfig().gantt,
  clear,
  setDateFormat,
  getDateFormat,
...
const setConf = function() {
  mermaid_core.log.debug("Something is calling, setConf, remove the call");
};
let w;
const draw = function(text, id, version, diagObj) {
  const conf = mermaid_core.getConfig().gantt;
  ...
  mermaid_core.configureSvgSize(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = mermaid_core.getConfig().securityLevel;
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = mermaid_core.select("#i" + id);
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    const excludeRanges = [];
    let range = null;
    let d = mermaid_core.dayjs(minTime);
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(mermaid_core.common.lineBreakRegex);
