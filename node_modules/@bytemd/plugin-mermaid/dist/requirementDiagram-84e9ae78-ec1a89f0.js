...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    mermaid_core.log.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  Relationships,
  parseDirective,
  getConfig: () => mermaid_core.getConfig().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + mermaid_core.common.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + mermaid_core.common.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    mermaid_core.log.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = mermaid_core.getConfig().requirement;
  diagObj.db.clear();
