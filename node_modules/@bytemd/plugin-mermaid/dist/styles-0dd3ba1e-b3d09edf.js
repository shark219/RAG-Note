...
const addRelation = function(relation) {
  mermaid_core.log.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = mermaid_core.common.sanitizeText(
    relation.relationTitle1.trim(),
    mermaid_core.getConfig()
  );
  relation.relationTitle2 = mermaid_core.common.sanitizeText(
...
const setLink = function(ids, linkStr, target) {
  const config = mermaid_core.getConfig();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = mermaid_core.utils.formatUrl(linkStr, config);
...
const db = {
  ...
  getConfig: () => mermaid_core.getConfig().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
