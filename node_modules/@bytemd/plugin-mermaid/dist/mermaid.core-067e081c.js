...
var hasOwnProperty$7 = Object.hasOwnProperty, setPrototypeOf = Object.setPrototypeOf, isFrozen = Object.isFrozen, getPrototypeOf = Object.getPrototypeOf, getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
...
exports.sanitizeUrl_1 = dist.sanitizeUrl = void 0;
...
exports.sanitizeUrl_1 = dist.sanitizeUrl = sanitizeUrl;
var noop$1 = { value: () => {
} };
function dispatch() {
...
const detectType = function(text2, config2) {
  ...
  for (const [key, { detector: detector2 }] of Object.entries(detectors)) {
    const diagram = detector2(text2, config2);
    if (diagram) {
      return key;
    }
  }
    ...
    Object.entries(detectors).map(async ([key, { detector: detector2, loader: loader2 }]) => {
      if (loader2) {
        try {
          ...
          try {
            const { diagram, id: id2 } = await loader2();
...
function formatUrl(linkStr, config2) {
  ...
  if (url) {
    if (config2.securityLevel !== "loose") {
      return exports.sanitizeUrl_1(url);
    }
    return url;
  }
}
...
const loader$i = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./c4Diagram-f9e67060-63bb6b75.js"));
...
const loader$h = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./flowDiagram-42bb1e4d-6f183d63.js"));
...
const loader$g = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./flowDiagram-v2-4c9a7611-13b0f1e7.js"));
...
const loader$f = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./erDiagram-25977acd-c672cd30.js"));
...
const loader$e = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./gitGraphDiagram-30dcca6d-000969c8.js"));
...
const loader$d = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./ganttDiagram-41439120-58647c59.js"));
...
const loader$c = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./infoDiagram-1b335302-64f66667.js"));
...
const loader$b = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./pieDiagram-905ac727-07614884.js"));
...
const loader$a = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./requirementDiagram-84e9ae78-ec1a89f0.js"));
...
const loader$9 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./sequenceDiagram-2c95880e-3a449ffb.js"));
...
const loader$8 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./classDiagram-4456d403-5d9f8b09.js"));
...
const loader$7 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./classDiagram-v2-539b00ca-f6b24281.js"));
...
const loader$6 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./stateDiagram-95825141-3f152b60.js"));
...
const detector$5 = (text2, config2) => {
  var _a, _b;
...
const loader$5 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./stateDiagram-v2-1cc5d8ed-519b5af6.js"));
...
const loader$4 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./journeyDiagram-ded66ec9-35b3c82d.js"));
...
const id$3 = "error";
const detector$3 = (text2) => {
  return text2.toLowerCase().trim() === "error";
};
const loader$3 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./errorDiagram-bb949655-145061ab.js"));
...
const loader$2 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./flowchart-elk-definition-c9fc5e04-4e844363.js"));
...
const loader$1 = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./timeline-definition-24ebf147-2e483bc0.js"));
...
const loader = async () => {
  const { diagram } = await Promise.resolve().then(() => require("./mindmap-definition-c8a05b8a-7d5df42c.js"));
  return { id, diagram };
};
const plugin = {
  id,
...
class Diagram {
  constructor(text2) {
    ...
    this.parser.parse = (text22) => originalParse(extractFrontMatter(text22, this.db));
...
async function parse$1(text2, parseOptions) {
  ...
  let error2;
  try {
    const diagram = await getDiagramFromText(text2);
    diagram.parse();
  } catch (err) {
    error2 = err;
  }
...
const render$1 = async function(id2, text2, svgContainingElement) {
  ...
  log$1.debug(config2);
  if (text2.length > ((_a2 = config2 == null ? void 0 : config2.maxTextSize) != null ? _a2 : MAX_TEXTLENGTH)) {
  ...
  try {
    ...
    renderer.draw(text2, id2, version);
    throw e;
  }
...
reset(getConfig$1());
const handleError = (error2, errors, parseError) => {
  log$1.warn(error2);
  if (isDetailedError(error2)) {
    if (parseError) {
      parseError(error2.str, error2.hash);
    }
    errors.push({ ...error2, message: error2.str, error: error2 });
  } else {
    if (parseError) {
      parseError(error2);
    }
...
const runThrowsErrors = async function({ postRenderCallback, querySelector, nodes } = {
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    try {
      ...
      handleError(error2, errors, mermaid.parseError);
    }
  }
  if (errors.length > 0) {
    throw errors[0];
...
exports.mermaid_core = mermaid_core;
exports.min = min;
exports.nodeUtil = nodeUtil$1;
exports.nogamma = nogamma;
exports.overArg = overArg;
exports.parseDirective$1 = parseDirective$1;
...
exports.root = root$2;
exports.root$1 = root$1;
exports.sanitizeText = sanitizeText$2;
...
exports.setupGraphViewbox = setupGraphViewbox$1;
exports.setupGraphViewbox$1 = setupGraphViewbox;
exports.sin = sin;
exports.sqrt = sqrt;
exports.tau = tau;
exports.utils = utils;
