...
const db = {
  parseDirective,
  getConfig: () => mermaid_core.getConfig().journey,
  clear,
...
function drawActorLegend(diagram2) {
  const conf2 = mermaid_core.getConfig().journey;
  let yPos = 60;
...
const conf = mermaid_core.getConfig().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  mermaid_core.configureSvgSize(diagram2, height, width, conf2.useMaxWidth);
