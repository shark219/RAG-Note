...
const draw = function(text, id, _version, diagObj) {
  ...
  for (const key of keys) {
    ...
    const node = svgDraw6a237a99.svgDraw.drawClass(diagram2, classDef, conf, diagObj);
  ...
  notes.forEach(function(note) {
    ...
    const node = svgDraw6a237a99.svgDraw.drawNote(diagram2, note, conf, diagObj);
    idCache[node.id] = node;
    g.setNode(node.id, node);
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      ...
      svgDraw6a237a99.svgDraw.drawEdge(diagram2, g.edge(e), g.edge(e).relation, conf, diagObj);
    }
  });
