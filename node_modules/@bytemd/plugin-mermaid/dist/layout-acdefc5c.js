...
function isSymbol(value) {
  return typeof value == "symbol" || mermaid_core.isObjectLike(value) && mermaid_core.baseGetTag(value) == symbolTag$3;
}
...
var INFINITY$3 = 1 / 0;
var symbolProto$2 = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : void 0, symbolToString = symbolProto$2 ? symbolProto$2.toString : void 0;
function baseToString(value) {
  if (typeof value == "string") {
    return value;
  }
  if (mermaid_core.isArray(value)) {
...
function toNumber(value) {
  ...
  if (mermaid_core.isObject(value)) {
    var other = typeof value.valueOf == "function" ? value.valueOf() : value;
    value = mermaid_core.isObject(other) ? other + "" : other;
  }
  if (typeof value != "string") {
...
var baseCreate = function() {
  ...
  return function(proto) {
    if (!mermaid_core.isObject(proto)) {
      return {};
    }
    if (objectCreate) {
...
var defineProperty = function() {
  try {
    var func = mermaid_core.getNative(Object, "defineProperty");
    func({}, "", {});
    return func;
  } catch (e) {
  }
...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty$7.call(object, key) && mermaid_core.eq(objValue, value)) || value === void 0 && !(key in object)) {
...
function isIterateeCall(value, index, object) {
  if (!mermaid_core.isObject(object)) {
    return false;
  }
  var type = typeof index;
  if (type == "number" ? mermaid_core.isArrayLike(object) && isIndex(index, object.length) : type == "string" && index in object) {
    return mermaid_core.eq(object[index], value);
  }
  return false;
}
...
function arrayLikeKeys(value, inherited) {
  var isArr = mermaid_core.isArray(value), isArg = !isArr && mermaid_core.isArguments(value), isBuff = !isArr && !isArg && mermaid_core.isBuffer(value), isType = !isArr && !isArg && !isBuff && mermaid_core.isTypedArray(value), skipIndexes = isArr || isArg || isBuff || isType, result = skipIndexes ? baseTimes(value.length, String) : [], length = result.length;
...
function keys(object) {
  return mermaid_core.isArrayLike(object) ? arrayLikeKeys(object) : mermaid_core.baseKeys(object);
}
...
function baseKeysIn(object) {
  ...
  var isProto = mermaid_core.isPrototype(object), result = [];
...
function keysIn(object) {
  return mermaid_core.isArrayLike(object) ? arrayLikeKeys(object, true) : baseKeysIn(object);
}
...
function memoizeCapped(func) {
  var result = mermaid_core.memoize(func, function(key) {
...
var spreadableSymbol = mermaid_core.Symbol ? mermaid_core.Symbol.isConcatSpreadable : void 0;
function isFlattenable(value) {
  return mermaid_core.isArray(value) || mermaid_core.isArguments(value) || !!(spreadableSymbol && value && value[spreadableSymbol]);
}
...
function stackClear() {
  this.__data__ = new mermaid_core.ListCache();
  this.size = 0;
}
...
function stackSet(key, value) {
  ...
  if (data instanceof mermaid_core.ListCache) {
    var pairs = data.__data__;
    if (!mermaid_core.Map || pairs.length < LARGE_ARRAY_SIZE$1 - 1) {
      pairs.push([key, value]);
      this.size = ++data.size;
      return this;
    }
    data = this.__data__ = new mermaid_core.MapCache(pairs);
  }
  data.set(key, value);
  this.size = data.size;
  return this;
...
function Stack(entries) {
  var data = this.__data__ = new mermaid_core.ListCache(entries);
  this.size = data.size;
}
...
var Buffer = moduleExports ? mermaid_core.root$1.Buffer : void 0, allocUnsafe = Buffer ? Buffer.allocUnsafe : void 0;
...
var getSymbolsIn = !nativeGetSymbols ? stubArray : function(object) {
  ...
  while (object) {
    ...
    object = isPlainObject.getPrototype(object);
  }
  return result;
};
...
function baseGetAllKeys(object, keysFunc, symbolsFunc) {
  ...
  return mermaid_core.isArray(object) ? result : arrayPush(result, symbolsFunc(object));
}
...
var Uint8Array = mermaid_core.root$1.Uint8Array;
...
var symbolProto$1 = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : void 0, symbolValueOf$1 = symbolProto$1 ? symbolProto$1.valueOf : void 0;
...
function initCloneObject(object) {
  return typeof object.constructor == "function" && !mermaid_core.isPrototype(object) ? baseCreate$1(isPlainObject.getPrototype(object)) : {};
}
var mapTag$2 = "[object Map]";
function baseIsMap(value) {
  return mermaid_core.isObjectLike(value) && mermaid_core.getTag(value) == mapTag$2;
}
var nodeIsMap = mermaid_core.nodeUtil && mermaid_core.nodeUtil.isMap;
var isMap = nodeIsMap ? mermaid_core.baseUnary(nodeIsMap) : baseIsMap;
const isMap$1 = isMap;
var setTag$2 = "[object Set]";
function baseIsSet(value) {
  return mermaid_core.isObjectLike(value) && mermaid_core.getTag(value) == setTag$2;
}
var nodeIsSet = mermaid_core.nodeUtil && mermaid_core.nodeUtil.isSet;
var isSet = nodeIsSet ? mermaid_core.baseUnary(nodeIsSet) : baseIsSet;
const isSet$1 = isSet;
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  var isArr = mermaid_core.isArray(value);
  if (isArr) {
    ...
    var tag = mermaid_core.getTag(value), isFunc = tag == funcTag || tag == genTag;
    if (mermaid_core.isBuffer(value)) {
...
function SetCache(values2) {
  ...
  this.__data__ = new mermaid_core.MapCache();
  while (++index < length) {
...
var symbolProto = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : void 0, symbolValueOf = symbolProto ? symbolProto.valueOf : void 0;
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case dateTag:
    case numberTag:
      return mermaid_core.eq(+object, +other);
    case errorTag:
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = mermaid_core.isArray(object), othIsArr = mermaid_core.isArray(other), objTag = objIsArr ? arrayTag : mermaid_core.getTag(object), othTag = othIsArr ? arrayTag : mermaid_core.getTag(other);
  objTag = objTag == argsTag ? objectTag : objTag;
  othTag = othTag == argsTag ? objectTag : othTag;
  var objIsObj = objTag == objectTag, othIsObj = othTag == objectTag, isSameTag = objTag == othTag;
  if (isSameTag && mermaid_core.isBuffer(object)) {
    if (!mermaid_core.isBuffer(other)) {
      return false;
    }
    objIsArr = true;
    objIsObj = false;
  ...
  if (isSameTag && !objIsObj) {
    stack || (stack = new Stack());
    return objIsArr || mermaid_core.isTypedArray(object) ? equalArrays(object, other, bitmask, customizer, equalFunc, stack) : equalByTag(object, other, objTag, bitmask, customizer, equalFunc, stack);
  }
...
function baseIsEqual(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || !mermaid_core.isObjectLike(value) && !mermaid_core.isObjectLike(other)) {
...
function isStrictComparable(value) {
  return value === value && !mermaid_core.isObject(value);
}
...
function hasPath(object, path, hasFunc) {
  ...
  return !!length && mermaid_core.isLength(length) && isIndex(key, length) && (mermaid_core.isArray(object) || mermaid_core.isArguments(object));
}
...
function baseIteratee(value) {
  ...
  if (typeof value == "object") {
    return mermaid_core.isArray(value) ? baseMatchesProperty(value[0], value[1]) : baseMatches(value);
  }
...
function createBaseEach(eachFunc, fromRight) {
  return function(collection, iteratee) {
    ...
    if (!mermaid_core.isArrayLike(collection)) {
...
var now = function() {
  return mermaid_core.root$1.Date.now();
};
const now$1 = now;
...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || mermaid_core.eq(value, objectProto$1[key]) && !hasOwnProperty$1.call(object, key)) {
...
function assignMergeValue(object, key, value) {
  if (value !== void 0 && !mermaid_core.eq(object[key], value) || value === void 0 && !(key in object)) {
    baseAssignValue(object, key, value);
  }
}
function isArrayLikeObject(value) {
  return mermaid_core.isObjectLike(value) && mermaid_core.isArrayLike(value);
}
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    var isArr = mermaid_core.isArray(srcValue), isBuff = !isArr && mermaid_core.isBuffer(srcValue), isTyped = !isArr && !isBuff && mermaid_core.isTypedArray(srcValue);
    newValue = srcValue;
    if (isArr || isBuff || isTyped) {
      if (mermaid_core.isArray(objValue)) {
        newValue = objValue;
    ...
    } else if (isPlainObject.isPlainObject(srcValue) || mermaid_core.isArguments(srcValue)) {
      newValue = objValue;
      if (mermaid_core.isArguments(objValue)) {
        newValue = toPlainObject(objValue);
      } else if (!mermaid_core.isObject(objValue) || mermaid_core.isFunction(objValue)) {
...
function baseMerge(object, source, srcIndex, customizer, stack) {
  ...
  baseFor$1(source, function(srcValue, key) {
    stack || (stack = new Stack());
    if (mermaid_core.isObject(srcValue)) {
...
function forEach(collection, iteratee) {
  var func = mermaid_core.isArray(collection) ? arrayEach : baseEach$1;
...
function filter(collection, predicate) {
  var func = mermaid_core.isArray(collection) ? arrayFilter : baseFilter;
...
function baseMap(collection, iteratee) {
  var index = -1, result = mermaid_core.isArrayLike(collection) ? Array(collection.length) : [];
...
function map(collection, iteratee) {
  var func = mermaid_core.isArray(collection) ? arrayMap : baseMap;
...
function baseSet(object, path, value, customizer) {
  ...
  while (nested != null && ++index < length) {
    ...
    if (index != lastIndex) {
      ...
      if (newValue === void 0) {
        newValue = mermaid_core.isObject(objValue) ? objValue : isIndex(path[index + 1]) ? [] : {};
      }
    }
...
function baseOrderBy(collection, iteratees, orders) {
  if (iteratees.length) {
    iteratees = arrayMap(iteratees, function(iteratee) {
      if (mermaid_core.isArray(iteratee)) {
  ...
  var index = -1;
  iteratees = arrayMap(iteratees, mermaid_core.baseUnary(baseIteratee));
...
function reduce(collection, iteratee, accumulator) {
  var func = mermaid_core.isArray(collection) ? arrayReduce : baseReduce, initAccum = arguments.length < 3;
...
var INFINITY = 1 / 0;
var createSet = !(mermaid_core.Set && 1 / setToArray(new mermaid_core.Set([, -0]))[1] == INFINITY) ? noop : function(values2) {
  return new mermaid_core.Set(values2);
};
...
class Graph {
  ...
  setDefaultNodeLabel(newDefault) {
    if (!mermaid_core.isFunction(newDefault)) {
  ...
  sources() {
    ...
    return filter(this.nodes(), function(v) {
      return mermaid_core.isEmpty(self._in[v]);
    });
  }
  sinks() {
    var self = this;
    return filter(this.nodes(), function(v) {
      return mermaid_core.isEmpty(self._out[v]);
    });
  }
  setNodes(vs, value) {
    var args = arguments;
