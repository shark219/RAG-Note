...
import com.rag.notebook.auth.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/user/login", "/user/login/", "/user/register", "/user/register/").permitAll()
    ...
    /**
     * Security 上下文支持子线程继承，解决 SSE/异步接口认证丢失问题
     */
    @Bean
